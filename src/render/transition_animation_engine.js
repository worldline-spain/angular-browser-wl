...
var TransitionAnimationEngine = (function () {
    ...
    TransitionAnimationEngine.prototype._flushAnimations = function (cleanupFns, microtaskId) {
        ...
        var enterNodesWithoutAnimations = new Set();
        for (var i = 0; i < allEnterNodes.length; i++) {
        ...
        var _a = cloakAndComputeStyles(this.driver, leaveNodesWithoutAnimations, allPostStyleElements, animations_1.AUTO_STYLE), postStylesMap = _a[0], allLeaveQueriedNodes = _a[1];
